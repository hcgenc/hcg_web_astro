  ...
  const services: Service[] = [
    {
      ...
      duration: "50 dakika",
      image: "/images/dogum-haritasi-okumasi.png",
      popular: true,
    },
    {
      ...
      duration: "40 dakika",
      image: "/images/ongoru_danismanligi.png",
    },
    {
      ...
      duration: "35 dakika",
      image: "/images/iliski_danismanligi.png",
    },
    {
      ...
      duration: "15 dakika",
      image: "/images/tek-soru-danismanligi.png",
    },
    {
      id: "ruya-tabiri",
      title: "Rüya Tabiri",
      ...
      duration: "Dijital Teslimat",
      image: "/images/ruya_tabiri.png",
    },
  ]
        ...
        <div className="flip-card-back absolute inset-0 w-full h-full [backface-visibility:hidden] [transform:rotateY(180deg)] bg-gradient-to-b from-black/80 via-black/60 to-black/80 flex flex-col justify-between rounded-xl overflow-hidden shadow-lg p-6">
          <div>
            <CardHeader className="bg-transparent p-0 mb-4">
              ...
              <CardDescription className="text-white/80 drop-shadow-md">{service.duration}</CardDescription>
            </CardHeader>
